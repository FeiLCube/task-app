        ...
        Object.keys(allTasks).forEach((taskId) => {
          ...
          if (taskData.userId == uid) {
            ...
            if (task.priority.name == 'high') {
              row.children[0].child.setAttribute('class', 'badge badge-danger');
            } else if (task.priority.name == 'medium') {
              row.children[0].child.setAttribute('class', 'badge badge-warning');
            } else if (task.priority.name == 'low') {
              row.children[0].child.setAttribute('class', 'badge badge-success');
            }
